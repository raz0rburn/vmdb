...
function startAjax(){
	...
	url="print.php?date="+date+"&cluster="+cluster+"&vmstate="+vmstate+"&vmname="+vmname+"&folder="+folder+"&ip_primary="+ip_primary+"&annotation="+annotation+"&vmwtools="+vmwtools+"&sortby="+sortby+"&order="+order;
...
<body><h3 align="center">Find VM by parameters</h3>
<table  align="center" >
<tr>
<td>
<form>
...
<td> 
	 <div class="select-sort">
		<form method="post" action="">
        	Folder :  <br /> <input type="text" id="folder" name="folder" />
...
<td>
	...
	<input type="radio" name="order" value="0" checked="checked">increase</input>
	<input type="radio" name="order" value="1">decrease</input>	
	<br/>
	<div class="select-sort">
...
<body><h3 align="center">Find by IP address</h3>
<table  align="center" >
...
<td>
	...
	<div class="select-sort">
		<select name="nic_connected" id="nic_connected">
			<option value="2">- choose state -</option>
