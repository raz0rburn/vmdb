...
def read_mysql_config(filename='config-mysql',section='client'):
...
def vm2db(datacenter, cluster, host, vm, summary):
    ...
    try:
        ...
        sql = "INSERT INTO vminfo (datetime,datacenter,cluster,host,vmname,folder,ip_primary,provisioned_space, guest_disk_usage, usage_storage,path,mem,cpu,ostype,state,annotation,vmwtools,boottime,guestos_id,template) VALUES ( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        val = [(timeNow,datacenter,cluster,host,vmname,folder,ip_primary,provisioned_space, guest_disk_usage, usage_storage,path,mem,cpu,ostype,state,annotation,vmwtools,boottime,guestos_id,template)]
        print(val)
